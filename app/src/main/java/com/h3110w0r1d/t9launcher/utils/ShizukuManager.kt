...
class ShizukuManager private constructor() {
    ...
    // Binder相关监听器
    private lateinit var binderReceivedListener: OnBinderReceivedListener
    ...
    fun initialize(context: Context, requestPermission: Boolean = true) {
        ...
        // 创建binderReceivedListener并捕获requestPermission参数
        binderReceivedListener = OnBinderReceivedListener {
            // 传递与initialize方法相同的requestPermission逻辑
